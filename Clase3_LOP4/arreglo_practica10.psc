Algoritmo sin_titulo
	Definir matriz_notas, acum_nota_alum, prom_alum, promNotas Como Real
	...
	promNotas = FuncDetPromedio(matriz_notas)
	
	Mostrar "El promedio general de las notas es: " promNotas
	
	Mostrar "La lista de los alumnos que superaron el promedio es: "
	Mostrar "Nombre   Nota Promedio "
	Para m=1 hasta 5
		si prom_alum[m] > promNotas
			Mostrar nombres[m] "         " Sin Saltar
			Mostrar prom_alum[m]
		fin si
	FinPara
...
Funcion promNotas = FuncDetPromedio(matriz_notas)
	acumNotas=0
	para f = 1 hasta 5
		para j = 1 hasta 3
			acumNotas = acumNotas + matriz_notas[f,j]	
		FinPara
	FinPara
	promNotas = acumNotas/15
FinFuncion
